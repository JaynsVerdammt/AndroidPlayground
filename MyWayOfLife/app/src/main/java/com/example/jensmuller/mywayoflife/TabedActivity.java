...
public class TabedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(createPackageContext("com.example.jensmuller.mywayoflife", 0), OverviewMap.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            try {
                Intent intent = new Intent(createPackageContext("com.example.jensmuller.mywayoflife", 0), LoginActivity.class);
                startActivity(intent);
            } catch (PackageManager.NameNotFoundException e) {
                e.printStackTrace();
            }
